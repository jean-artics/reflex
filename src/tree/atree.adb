...
package body Atree is
   ...
   begin
      ...
      --  Nodes.Last.
         ...
         --   Reflex add
         Trans_Nodes.Append (No_Reflex_Transform_Record); -- (Empty);
      ...
      --  Reflex Add
      Trans_Nodes.Set_Last (Nodes.Last);
   ...
   begin
      ...
      Trans_Nodes.Table (Destination) := Trans_Nodes.Table (Source);
   ...
   function Get_Rx_Infos
     (Node : Node_Id) return System.Address is
   begin
      pragma Assert (Node <= Trans_Nodes.Last);
      return Trans_Nodes.Table (Node);
   end Get_Rx_Infos;
   ...
   procedure Set_Rx_Infos
     (Node     : Node_Id;
      Rx_Infos : System.Address) is
   begin
      pragma Assert (Node <= Trans_Nodes.Last);
      Trans_Nodes.Table (Node) := Rx_Infos;
   end Set_Rx_Infos;

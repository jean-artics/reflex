...
package body Artics.Elmt_Nlists is
   ...
   function Is_Valid_Elmt
     (Obj : Elmt_Id) return Boolean is
   ...
   function First
     (List : List_Id) return Elmt_Id is
   ...
   function No
     (List : List_Id) return Boolean is
   ...
   function Get_Elmt_Ptr
     (Obj : Elmt_Id) return Elmt_T_Ptr is
   ...
   procedure Allocate_List_Tables
     (Obj : Elmt_Id) is
   ...
   function Is_Non_Empty_List
     (List : List_Id) return Boolean is

   begin
       return List /= No_List and then First (List) /= No_Elmt;
   ...
   function List_Containing
     (Obj : Elmt_Id) return List_Id is
   ...
   function New_List_Copy
     (List : List_Id) return List_Id is

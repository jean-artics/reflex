...
package Sinfo is
   ...
   ---------------------
      ...
      --  The full type declaration node is used only for the first case. 
      ...
      --  Note: ABSTRACT, TAGGED  are not permitted in Ada 83 mode
      ...
      --  | RETURN_STATEMENT      | CODE_STATEMENT
      ...
      --  PRIVATE_TYPE_DECLARATION ::=
      --    type DEFINING_IDENTIFIER is [[abstract] tagged]] private;
...
--       (N : Node_Id; Val : Entity_Id);          -- Node1
   ...
   function Ada_Real_Literal (N : Node_Id) return String_Id;
   procedure Set_Ada_Real_Literal (N : Node_Id; Val : String_Id);
   ...
   --  using the makeisf utility (currently this program is in spitbol).
     ...
     N_Pragma =>
       (1 => True,    --  Chars (Name1)
        ...
        4 => False,   --  Next_Rep_Item (Node4-Sem)
        5 => False),  --  unused
     ...
     N_Component_Definition =>
       (1 => False,   --  unused
        2 => False,   --  unused
        3 => False,   --  unused -- Access_Definition (Node3)
        4 => False,   --  unused
        5 => True),   --  Subtype_Indication (Node5)
     ...
     N_Allocator =>
       (1 => False,   --  Storage_Pool (Node1-Sem)
        2 => False,   --  unused
        3 => True,    --  Expression (Node3)
        4 => False,   --  Procedure_To_Call (Node4-Sem)
        5 => False),  --  Etype (Node5-Sem)
     ...
     N_Return_Statement =>
       (1 => False,   --  Storage_Pool (Node1-Sem)
        2 => False,   --  Return_Type (Node2-Sem)
        3 => True,    --  Expression (Node3)
        4 => False,   --  Procedure_To_Call (Node5-Sem)
     ...
     N_Formal_Type_Declaration =>
       (1 => True,    --  Defining_Identifier (Node1)
        ...
        4 => False,   --  ?? Discriminant_Specifications (List4)
        5 => False),  --  unused
     ...
     N_Record_Representation_Clause =>
       (1 => True,    --  Identifier (Node1)
        ...
        4 => False,   --  Next_Rep_Item (Node5-Sem)
        5 => False),  --  unused

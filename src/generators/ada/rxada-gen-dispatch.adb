...
with Rxada.Gen.Ch5; use Rxada.Gen.Ch5;
with Rxada.Gen.Ch6; use Rxada.Gen.Ch6;
with Rxada.Gen.Ch7; use Rxada.Gen.Ch7;
...
package body Rxada.Gen.Dispatch is
   ...
   begin
      -- Put_Line ("Ada.Gen.Dispatch: Generate_Node " & Nkind (Node)'Img);
...
--      This.Set_Output_Buffer (This.Get_Dummy_Output_Buffer);
      ...
      -- Put_Line ("Dispatch Node " & Nkind (Node)'Img);
      case Nkind (Node) is
	 ...
	 --  Types declarations 
	   ...
	   | N_Private_Type_Declaration        =>
	    ...
	    RxAda.Gen.Ch3.Generate_Object_Declaration (This, Node);
	    ...
	    Generate_Abstract_Subprogram_Declaration (This, Node);
	    ...
	    Generate_Access_Definition (This, Node);
         ...
         when N_Aggregate =>
	    RxAda.Gen.Ch4.Generate_Aggregate (This, Node);
	    ...
	    raise Program_Error;
         ...
         when N_And_Then =>
	    RxAda.Gen.Ch4.Generate_And_Then (This, Node);
...
--              raise Program_Error;
	    ...
	    RxAda.Gen.Ch5.Generate_Assignment_Statement (This, Node);
...
--              raise Program_Error;
	    ...
	    RxAda.Gen.Ch5.Generate_Case_Statement (This, Node);
	    ...
	    raise Program_Error; --  Generate_Component_Definition (This, Node);
         ...
         when N_Component_Declaration =>
            null; -- Ada.Decls.Generate_Component_Declaration (This, Node);
...
--              raise Program_Error; -- should not occur in generated code
	    ...
	    Generate_Discriminant_Association (This, Node);

         when N_Elsif_Part =>
	    null; --  Ada.Gen.Ch5.Generate_Elsif_Part (This, Node);
         ...
         =>
            RxAda.Gen.Ch3.Generate_Enumeration_Type_Definition (This, Node);
	    ...
	    RxAda.Gen.Ch2.Generate_Expanded_Name (This, Node);
...
--              null; -- not output in C code
	    ...
	    Generate_Function_Specification (This, Node);
	    ...
	    Generate_Generic_Package_Declaration (This, Node);
	    
	 when N_Generic_Subprogram_Declaration =>
	    Generate_Generic_Subprogram_Declaration (This, Node);
	    
         when N_Goto_Statement =>
            Generate_Goto_Statement (This, Node);

         when N_Handled_Sequence_Of_Statements =>
	    RxAda.Gen.Ch5.Generate_Handled_Sequence_Of_Statements (This, Node);

         when N_Identifier =>	
	    RxAda.Gen.Ch2.Generate_Identifier (This, Node);

--           when N_If_Expression =>
--  	    Generate_If_Expression (This, Node);

         when N_If_Statement =>
	    RxAda.Gen.Ch5.Generate_If_Statement (This, Node);

         when N_Implicit_Label_Declaration =>
	    Generate_Implicit_Label_Declaration (This, Node);

         when N_In =>
	    Generate_In (This, Node);

         when N_Index_Or_Discriminant_Constraint =>
            Generate_Index_Or_Discriminant_Constraint (This, Node);

         when N_Indexed_Component =>
	    Generate_Indexed_Component (This, Node);

         when N_Integer_Literal =>
	    RxAda.Gen.Ch4.Generate_Integer_Literal (This, Node);
	    ...
	    RxAda.Gen.Ch5.Generate_Loop_Statement (This, Node);
	    ...
	    Generate_Number_Declaration (This, Node);
         ...
         when N_Op_Abs =>
	    RxAda.Gen.Ch4.Generate_Op_Abs (This, Node);
	    
         when N_Op_Add =>
	    RxAda.Gen.Ch4.Generate_Op_Add (This, Node);

         when N_Op_And =>
	    RxAda.Gen.Ch4.Generate_Op_And (This, Node);

         when N_Op_Concat =>
            raise Program_Error; -- should always be expanded

         when N_Op_Divide =>
	    RxAda.Gen.Ch4.Generate_Op_Divide (This, Node);

         when N_Op_Eq =>
	    RxAda.Gen.Ch4.Generate_Op_Eq (This, Node);
	    
         when N_Op_Expon =>
	    RxAda.Gen.Ch4.Generate_Op_Expon (This, Node);

         when N_Op_Ge =>
	    RxAda.Gen.Ch4.Generate_Op_Ge (This, Node);

         when N_Op_Gt =>
	    RxAda.Gen.Ch4.Generate_Op_Gt (This, Node);

         when N_Op_Le =>
	    RxAda.Gen.Ch4.Generate_Op_Le (This, Node);

         when N_Op_Lt =>
	    RxAda.Gen.Ch4.Generate_Op_Lt (This, Node);

         when N_Op_Minus =>
	    RxAda.Gen.Ch4.Generate_Op_Minus (This, Node);

         when N_Op_Mod =>
	    RxAda.Gen.Ch4.Generate_Op_Mod (This, Node);

         when N_Op_Multiply =>
	    RxAda.Gen.Ch4.Generate_Op_Multiply (This, Node);

         when N_Op_Ne =>
	    RxAda.Gen.Ch4.Generate_Op_Ne (This, Node);

         when N_Op_Not =>
	    RxAda.Gen.Ch4.Generate_Op_Not (This, Node);

         when N_Op_Or =>
	    RxAda.Gen.Ch4.Generate_Op_Or (This, Node);

         when N_Op_Plus =>
	    RxAda.Gen.Ch4.Generate_Op_Plus (This, Node);

         when N_Op_Rem =>
	    RxAda.Gen.Ch4.Generate_Op_Rem (This, Node);
         ...
         when N_Op_Subtract =>
	    RxAda.Gen.Ch4.Generate_Op_Subtract (This, Node);
	    ...
	    null;
         ...
         when N_Procedure_Specification =>
            Generate_Procedure_Specification (This, Node);
...
--              Generate_Raise_Expression (This, Node);
	    ...
	    RxAda.Gen.Ch2.Generate_Selected_Component (This, Node);
...
null;
         ...
         when N_String_Literal =>
            RxAda.Gen.Ch4.Generate_String_Literal (This, Node);

         when N_Subprogram_Body =>
	    RxAda.Gen.Ch6.Generate_Subprogram_Body (This, Node);

         when N_Subprogram_Declaration =>
            RxAda.Gen.Ch6.Generate_Subprogram_Declaration (This, Node);

         when N_Subprogram_Renaming_Declaration =>
            Generate_Subprogram_Renaming_Declaration (This, Node);

         when N_Subtype_Indication =>
	    Generate_Subtype_Indication (This, Node);

         when N_Type_Conversion =>
            RxAda.Gen.Ch4.Generate_Type_Conversion (This, Node);
